...
3.Design the Verilog Code for ROM:
4.Write the Verilog code for a 4KB ROM memory with read and write capabilities.
...
## Verilog Code:
### 4KB ROM Memory with Read and Write Operations: 
